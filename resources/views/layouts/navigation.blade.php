    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- gde nav -->
                <x-nav-link-parent :href="'#'" :active="request()->routeIs('customers.*')">
                ...
                <x-nav-link-parent :href="'#'" :active="request()->routeIs('tasks.*')">
                    <x-slot name="name">Follow Up Tasks</x-slot>
                    <x-slot name="children">
                        <a href="/tasks">List</a>
                        <span class="separator"></span>
                        <a href="{{route('assignable-list')}}">Assignment</a>
                        <!-- <span class="separator"></span>
                        <a href="#">Item C</a>
                        <span class="separator"></span>
                        <a href="#">Item D</a> -->
